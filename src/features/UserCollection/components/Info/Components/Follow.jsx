  ...
  return (
    <div className={styles.FollowWrapper}>
      ...
      <div className={styles.floorPrice}>
        <div className={styles.num}>{new BigNumber(volumeTrade()).dividedBy(participant()*(10**18)).toFixed(4).toString()}</div>
        <div className={styles.name}>Floor price</div>
      </div>
      <div className={styles.volumneTraded}>
        <div className={styles.num}>{new BigNumber(volumeTrade()).dividedBy(10**18).toFixed(4).toString()}</div>
